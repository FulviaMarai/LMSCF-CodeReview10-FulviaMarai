...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
 ...
 <body>
  <div class="container">
    <br>
  <div class="jumbotron ">
    <h1 class="display-4"> Update Media </h1>
  </div>
      ...
      <div class="row">
        ...
        <div class="col">
            <label for="description"> A short description </label> <br>
              <input type="textarea"  name="description" placeholder ="Max 255 charachters" value="<?php echo $data['description'] ?>"/> <br>
...
<br>
               ...
               <button type="submit" class='btn btn-outline-info btn-lg'>Save Changes</button >

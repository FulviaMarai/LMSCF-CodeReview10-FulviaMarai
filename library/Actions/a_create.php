...
if ($_GET) {
  ...
  $description = $_GET['description'];
   ...
   $sql = "INSERT INTO media (cover, title, author, publisher, publish_date, type, ISBN, description) VALUES ('$cover','$title','$author','$publisher','$publish_date','$type','$ISBN','$description')";
